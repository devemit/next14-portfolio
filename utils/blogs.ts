export default [
  ...
  },
  {
    ...
    skills:
      'Typescript: Used for building the application with type safety, NextJS-15: Employed for creating a dynamic user interface, Tailwind CSS: Applied for styling and ensuring consistent visual presentation of the ECG data and other UI elements.',
  },
  {
    date: '12.05.2024',
    slug: 'view-ecg',
